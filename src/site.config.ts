  ...
  head: [
    {
      ...
      attrs: { 
        name: 'keywords', 
        content: '边缘星云, 边缘星2020, byx2020, edgestar2020, 边缘星的杂货铺, 边缘星, edgestar, byx, 边缘云, edgecloud' // 替换为你的全站通用关键词，用逗号分隔
      }
    }
    /*  Telegram频道 */
    // {
...
export const integ: IntegrationUserConfig = {
  ...
  waline: {
    ...
    additionalConfigs: {
      ...
      locale: {
        reaction0: '点赞',
        placeholder: '欢迎评论留言。\n（填写邮箱后可在评论区显示你的Gravatar头像，同时在你的评论被他人回复时会收到邮件通知，无需登录）'
      },
      imageUploader: false
    }
  }
